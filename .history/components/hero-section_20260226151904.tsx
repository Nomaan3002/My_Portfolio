    ...
    >
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-12 lg:flex-row lg:items-center lg:justify-between">
        ...
        >
          ...
          <h1 className="mb-2 text-2xl font-bold leading-tight tracking-tight text-foreground md:text-5xl lg:text-6xl text-balance">
            Building Secure &{" "}
        ...
        {/* Right - Profile Photo */}
        <div
          className={`flex shrink-0 items-center justify-center transition-all delay-300 duration-700 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          <div className="relative">
            {/* Outer Glow Ring */}
            <div className="absolute -inset-3 rounded-full bg-linear-to-br from-primary via-accent to-primary opacity-60 blur-md animate-pulse-glow" />
            {/* Gradient Border */}
